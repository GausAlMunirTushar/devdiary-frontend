...
export const api = {
  ...
  post: (endpoint, body, token) => apiCall(endpoint, { method: 'POST', body, token }),
  put: (endpoint, body, token) => apiCall(endpoint, { method: 'PUT', body, token }),
  patch: (endpoint, body, token) => apiCall(endpoint, { method: 'PATCH', body, token }),
